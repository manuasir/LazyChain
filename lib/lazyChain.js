...
const LazyBlock = require('./lazyBlock')

/**
 * LazyChain class: encapsulates and manages a blockchain
 */
class LazyChain {
  constructor () {
    this.chain = []
    this.currentBlock = {}
    this.genesisBlock = new LazyBlock({
      index: 0,
